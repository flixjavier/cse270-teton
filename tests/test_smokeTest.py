...
class TestSmokeTest():
  ...
  def test_adminpage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("flixlopez")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("qwertyu")
  ...
  def test_joinpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("felix")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Flores")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Agro")
